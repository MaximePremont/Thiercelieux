...
public abstract class WWClass
{
	...
	public static final WWClass[] VALUES = new WWClass[]{SEER, WEREWOLF, SIMPLE_VILLAGER, LITTLE_GIRL};
	public static final WWClass[] NIGHT_ORDER = new WWClass[]{SEER, WEREWOLF};
